...
for i in range(len(snake_generations)):
    ...
    for j in range(len(snakes)):
        ...
        pygame.display.set_caption(
            'Generation : ' + str(i + 1) + '\t\tSnake Num: ' + str(j + 1) + '\t\tPrevious Score: ' + str(prev_score))
        ...
        while t_snake.isAlive():
            ...
            if (t_snake.head_x, t_snake.head_y) == environment.apple_position:
                ...
                result = t_snake.neuralnet.decision(t_snake.head_x, t_snake.head_y, t_snake.snake_position,
                                                    t_snake.direction)
